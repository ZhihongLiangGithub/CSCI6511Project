...
public class connectService {
	...
	public String getMoves() throws Exception {
		String getUrl = url + "?type=moves&gameId=1074&count=1"; // test get members of
		String res = "";
...
//      print result
//      basically should set a timer here, and check the response of each request. if we get the same response, skip it. Otherwise we get the new move information
...
//		get the move step
	...
	public void makeMove(String move) throws Exception {
		URL obj = new URL(url);
		HttpURLConnection conn = (HttpURLConnection) obj.openConnection();
		String parameters = "teamId=1051&type=move&gameId=1074&move=";
