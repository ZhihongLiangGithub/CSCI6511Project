...
public class Test {
    ...
    public void playGameAiVsHuman(int aiMaxSearchDepth, int aiMaxSearchSpace, boolean humanPlayFirst) throws Exception {
    ...
    public void playGameAiVsAi(int p1MaxSearchDepth, int p1MaxSearchSpace, int p2MaxSearchDepth, int p2MaxSearchSpace) throws Exception {
