...
According to the definition or winning window, a chess placed on the board can only effect the score of windows that containing the chess. Therefore, I pass the board score down with the recursion and update the board score according to the partial difference, 
